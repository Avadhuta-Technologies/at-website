export const homePodsData = {
  ...
  featuredPodIds: ['ecommerce-engine','admin-workflow-automation', 'ai-ml-integration', 'ai-product-studio','ar-vr-experience','mobile-first-saas','product-launch'],
}; 