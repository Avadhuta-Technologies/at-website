export const packsData = {
  ...
  faq: {
    ...
    items: [
      {
        question: "❓ How do packs differ from pods?",
        answer: "Pods are ongoing teams for long-term projects, while packs are fixed-scope deliverables for specific outcomes. Packs are perfect when you need a particular result—like launching a website or setting up analytics—without managing a team."
      },
      {
      ...
      {
        question: "🔐 Do I own all the deliverables?",
